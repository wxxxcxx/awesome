...
theme.wallpaper = gears.filesystem.get_configuration_dir() .. "wallpapers/life_and_death.png"
...
theme.taglist_bg_occupied = utils.color.opacity(gtk_theme.selected_bg_color, 0.4)
theme.taglist_bg_volatile = utils.color.opacity(gtk_theme.selected_bg_color, 0.4)
...
theme.tooltip_border_color = utils.color.auto_lighten_or_darken(gtk_theme.tooltip_bg_color, 20)
